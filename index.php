...
<ul class="slides">
 <li>
   <!-- SLIDE IMAGE -->
   <div data-stellar-ratio="0.5" class="slide-image" style="background-image:url(/images/fotos/foto1.jpg); background-position:top center">
   </div>
...
<!--                         	<a href="index.html">
                    			<div class="css-logo rounded">
                   					<div class="css-logo-text">
                        				<strong>C</strong><i class="de-icon-heart-1"></i><strong>C</strong>
                    				</div>
                    			</div>
                       </a> -->
                      ...
                      <li>
                        <a href="#our-story">NOSSA HISTÓRIA</a>
                      </li>
                      <li>
                       <a href="#where-when">QUANDO &amp; ONDE</a>
                     </li>
                     <li>
                       <a href="#groomsmen-section">PADRINHOS</a>
                     </li>
                     <li>
                       <a href="#bridesmaid-section">MADRINHAS</a>
                     </li>
                     <li>
              ...
              <div class="container">
               <div class="row">
                ...
                <div class="col-md-6">
                 ...
                 <!--PHOTO-ITEM-->
                 <div class="photo-item frame-border animation fadeInLeft" style="    height: 555px;">

                  <!--PHOTO-->
                  <img src="/images/fotos/caio.jpg"  alt="" class="hover-animation image-zoom-in">
                ...
                <div class="his-her-name">
                  <h2 class="text-center">CAIO<span class="last-name">-&nbsp;o nerd&nbsp;-</span></h2>
...
<!--                             <p class="blurb animation fadeInLeft text-center">
                          ...
                          <div class="col-md-6">
                           ...
                           <div class="photo-item frame-border animation fadeInRight">
                            ...
                            <!--PHOTO-->
                            <img src="/images/fotos/foto_carol2.jpg" alt="" class="hover-animation image-zoom-in">
                            <!-- <img src="/images/fotos/foto_carol_2.png" alt="" class="hover-animation image-zoom-in"> -->
                          ...
                          <div class="his-her-name">
                            <h2 class="text-center">CAROL<span class="last-name">-&nbsp;a veterinária&nbsp;-</span></h2>
                          </div>
...
<!--                             <p class="blurb animation fadeInRight text-center">
                    ...
                    <section id="photo-divider">
                     <div class="image-divider fixed-height" style="background-image:url(/images/fotos/foto2.jpg); height:600px" data-stellar-background-ratio="0.3">
                     </div>
                   </section>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12 col-md-offset-2 col-md-8 text-center">
                         ...
                         <div class="section-title animation fadeInUp">
                          <h2>
                            NOSSA <img src="images/heart-icon.png" alt=""> HISTÓRIA
                          </h2>

                          <p>
                            Nossa história começou em 2012 quando Carol, ainda caloura na veterinária, foi para
                            o seu primeiro congresso com a professora Drª Aline Pinna. Mal sabia ela que ficaria
                            hospedada na casa do sobrinho da professora em Campinas, e que teria que dividir 16 m²
                            com seus cinco colegas de viagem. O encontro foi breve, um jantar no Outback com toda a turma,
                            e depois ele seguiu viagem e deixou o apartamento... mas ele jura que ficou pensando nela desde lá.
                          </p>
                    ...
                    <div class="row story-row">
                      ...
                      <div class="col-sm-12 col-md-offset-1 col-md-4 text-center">
                        ...
                        <div class="photo-item frame-border animation delay1 fadeInLeft">
                          ...
                          <!--PHOTO-->
                          <img src="/images/fotos/shop.png" alt="" class="hover-animation image-zoom-in">
                      ...
                      <div class="col-sm-12 col-md-2 text-center story-date-wrapper animation fadeIn">
                       ...
                       <div class="story-date">
                         <div class="date-only">01</div>
                         <div class="month-year">12.13</div>
                       </div>
                     ...
                     <div class="col-sm-12 col-md-4 animation delay1 fadeInRight">
                       ...
                       <p>
                         O primeiro encontro do casal pareceu um tanto quanto arranjado. Depois de mais uma tentativa frustrada dele de encontrá-la
                         em alguma festa, sua tia, então professora da Carol, propõe que se encontrem na Hípica todos juntos. Logo depois surge a ideia
                         de um cinema e é lá que acontece o primeiro beijo, numa noite em que tudo pareceu mágico.
                       </p>
                     </div>
                   ...
                   <div class="row story-row">
                    ...
                    <div class="col-sm-12 col-md-4 col-md-push-6 text-center">
                      ...
                      <div class="photo-item frame-border animation delay1 fadeInLeft">
                        ...
                        <!--PHOTO-->
                        <img src="/images/fotos/cabo.jpg" alt="" class="hover-animation image-zoom-in">
                   ...
                   <div class="col-sm-12 col-md-4 col-md-pull-6 animation delay1 fadeInRight">
                     <h3>O NAMORO</h3>
                     <p>
                       Dois meses depois do primeiro beijo eles ainda estão juntos e nada melhor para comemorar do que indo para o Cabo Folia, em Cabo Frio.
                       Foi lá que decidiram que não se desgrudariam mais e que o namoro iria começar.
                     </p>
                   </div>
                 ...
                 <div class="row story-row">
                  ...
                  <div class="col-md-offset-1 col-md-4 text-center">
                    ...
                    <div class="photo-item frame-border animation delay1 fadeInLeft">
                      ...
                      <!--PHOTO-->
                      <img src="/images/fotos/viagem.jpg" alt="" class="hover-animation image-zoom-in">
                 ...
                 <div class="col-md-4 animation delay1 fadeInRight">
                  <h3>A DISTÂNCIA</h3>
                  <p>Um dia depois do início do namoro Caio volta para Campinas e o casal começa a encarar a distância. Mesmo com várias (várias mesmo) horas dentro de ônibus, vários dias sem se ver e apesar de toda a distância, o amor dos dois só aumenta a cada dia. A paixão é tanta que eles vivem cada dia como se fosse o último quando estão juntos.</p>
              ...
              <div class="row story-row">
                ...
                <div class="col-sm-12 col-md-4 col-md-push-6 text-center">
                  ...
                  <div class="photo-item frame-border animation delay1 fadeInLeft">
                    ...
                    <!--PHOTO-->
                    <img src="/images/fotos/rio.jpg" alt="" class="hover-animation image-zoom-in">
               ...
               <div class="col-sm-12 col-md-4 col-md-pull-6 animation delay1 fadeInRight">
                <h3>A VOLTA PRO RIO</h3>
                <p>No início de 2015 Caio recebe uma proposta de emprego e decide mudar para o Rio de Janeiro novamente. A vontade de ficar junto é tanta que até a distância da Barra da Tijuca pra Niterói parece grande e, em Maio, o casal decide morar junto.</p>
              </div>
            ...
            <div class="row story-row">
              ...
              <div class="col-md-offset-1 col-md-4 text-center">
                ...
                <div class="photo-item frame-border animation delay1 fadeInLeft">
                  ...
                  <!--PHOTO-->
                  <img src="/images/fotos/foto4.jpg" alt="" class="hover-animation image-zoom-in">
             ...
             <div class="col-md-4 animation delay1 fadeInRight">
              <h3>O PEDIDO</h3>
              <p>Caio não se imagina mais vivendo sem Carol e a surpreende pedindo em casamento. E ela diz SIM!.</p>
          ...
          <div class="row story-row">
            ...
            <div class="col-sm-12 col-md-4 col-md-push-6 text-center">
              ...
              <div class="photo-item frame-border animation delay1 fadeInLeft">
                ...
                <!--PHOTO-->
                <img src="/images/fotos/js.jpg" alt="" class="hover-animation image-zoom-in">
           ...
           <div class="col-sm-12 col-md-4 col-md-pull-6 animation delay1 fadeInRight">
            <h3>E QUE VENHAM OS FILHOS... CANINOS!</h3>
            <p>Jon e Snow se tornam os primeiros integrantes dessa nova família!</p>
          </div>
   ...
   <section id="photo-divider-1">
     <div class="image-divider fixed-height" style="background-image:url(/images/fotos/foto3.jpg); height:500px" data-stellar-background-ratio="0.3">
     </div>
   </section>
     ...
     <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-offset-2 col-md-8 text-center">
         ...
         <div class="section-title animation fadeInUp">
          <h2>
            QUANDO <span class="and">&amp;</span> ONDE
          </h2>
...
<div class="row">
 ...
 <p>Nossa cerimônia acontecerá na <a href="http://casafroes.com.br/" target="_blank">Casa Fróes - Alameda Jandira Fróes, 42 - São Francisco, Niterói - RJ, 24360-017</a>. Começaremos às 20 horas e logo depois teremos uma recepção
   ...
   <h3 class="inline">ACOMODAÇÕES</h3>
   <p>Pra você que vem de fora sugerimos que procure uma estadia no <a target="_blank" href="https://www.airbnb.com.br/">AirBnb</a>. Além de ser mais em conta, você tem uma infinidade de opções pra aproveitar a Cidade Maravilhosa.</p>
...
<section id="dont-miss-it">
 <div class="image-divider auto-height" style="background-image:url(/images/fotos/fundo2.jpg);" data-stellar-background-ratio="0.3">

  <div class="container">
   <div class="row">
     <div class="col-md-offset-2 col-md-8">

      <h2 id="dont-miss-it-title" class="text-center animation fadeInUp">Não perca !</h2>
    ...
    <div class="col-md-3">
      ...
      <div class="groomsmen-item">
       ...
       <div class="photo-item frame-border animation fadeIn">
         ...
         <!--PHOTO-->
         <img src="/images/fotos/frisone.jpg" alt="" class="hover-animation image-zoom-rotate">
 ...
 <div class="col-md-3">
  ...
  <div class="groomsmen-item">
   ...
   <div class="photo-item frame-border animation fadeIn">
     ...
     <!--PHOTO-->
     <img src="/images/fotos/gui.jpg" alt="" class="hover-animation image-zoom-rotate">
...
<div class="col-md-3">
  ...
  <div class="groomsmen-item">
   ...
   <div class="photo-item frame-border animation fadeIn">
     ...
     <!--PHOTO-->
     <img src="/images/fotos/joaoh.jpg" alt="" class="hover-animation image-zoom-rotate">
...
<div class="col-md-3">
  ...
  <div class="groomsmen-item">
   ...
   <div class="photo-item frame-border animation fadeIn">
     ...
     <!--PHOTO-->
     <img src="/images/fotos/joaof.jpg" alt="" class="hover-animation image-zoom-rotate">
...
<section id="photo-divider-3">
 <div class="image-divider fixed-height" style="background-image:url(/images/fotos/fundo3.jpg); height:450px" data-stellar-background-ratio="0.3">
 </div>
</section>
    ...
    <div class="col-md-3">
      ...
      <div class="bridesmaid-item">
       ...
       <div class="photo-item frame-border animation fadeIn">
         ...
         <!--PHOTO-->
         <img src="/images/fotos/mariana.jpg" alt="" class="hover-animation image-zoom-rotate">
 ...
 <div class="col-md-3">
  ...
  <div class="bridesmaid-item">
   ...
   <div class="photo-item frame-border animation fadeIn">
     ...
     <!--PHOTO-->
     <img  height="240" src="/images/fotos/bia.jpg" alt="" class="hover-animation image-zoom-rotate">
...
<div class="col-md-3">
  ...
  <div class="bridesmaid-item">
   ...
   <div class="photo-item frame-border animation fadeIn">
     ...
     <!--PHOTO-->
     <img  height="240" src="/images/fotos/nata.jpg" alt="" class="hover-animation image-zoom-rotate">
...
<div class="col-md-3">
  ...
  <div class="bridesmaid-item">
   ...
   <div class="photo-item frame-border animation fadeIn">
     ...
     <!--PHOTO-->
     <img  height="240" src="/images/fotos/duda.jpg" alt="" class="hover-animation image-zoom-rotate">
...
<div class="col-md-3">
  ...
  <div class="bridesmaid-item">
   ...
   <div class="photo-item frame-border animation fadeIn">
     ...
     <!--PHOTO-->
     <img  height="240" src="/images/fotos/nath.jpg" alt="" class="hover-animation image-zoom-rotate">
...
<div class="col-md-3">
  ...
  <div class="bridesmaid-item">
   ...
   <div class="photo-item frame-border animation fadeIn">
     ...
     <!--PHOTO-->
     <img  height="240" src="/images/fotos/leticia.jpg" alt="" class="hover-animation image-zoom-rotate">
...
<div class="col-md-3">
  ...
  <div class="bridesmaid-item">
    ...
    <div class="photo-item frame-border animation fadeIn">
      ...
      <!--PHOTO-->
      <img  height="240" src="/images/fotos/brunan.jpg" alt="" class="hover-animation image-zoom-rotate">
    ...
    <div class="row">
      ...
      <div class="col-md-offset-2 col-md-8 text-center">
       ...
       <div class="section-title animation fadeInUp">
        ...
        <p>
          Nosso maior presente será a sua presença no dia mais importante de nossas vidas. Mas se quiser dar algo, colocamos nessas listas nossas
  ...
  <div class="row">
   <div class="col-md-offset-1 col-md-10 text-center">
    <div id="registry-logo" class="owl-carousel">
     <div class="item"> <a href="http://www.camicado.com.br/weddinglist/products/60301013" target="_blank"> <img style="    height: 67px;" src="http://www.shoppingrecife.com.br/externos/lojas/marca/thumb_543235.jpg" alt=""> </a> </div>
     <div class="item"> <a href="http://www.pontofrio.com.br/Site/ListaGerenciadaLandingPage.aspx?idListaCompra=532321" target="_blank"> <img  style="    height: 67px;" src="https://upload.wikimedia.org/wikipedia/pt/e/e8/Logotipo_do_Pontofrio.png" alt=""> </a> </div>
   </div>
 </div>
</div>
    ...
    <div class="row">
      ...
      <div class="col-md-offset-2 col-md-8 text-center">
       ...
       <div class="section-title animation fadeInUp">
        ...
        <p>
          É muito importante que vocês confirmem sua presença no nosso casamento para que tudo ocorra como planejamos. Você pode também confirmar para seu pai,
          mãe, namorado ou amigo que vai junto com você. Não se esqueça que cada convite individual requer a confirmação.
        </p>

        <h3><a target="_blank" href="https://docs.google.com/forms/d/15C4ItM_WLZsA4QpJwoGJ09ANo6JBJ5InsQpgoRCKa5k/viewform#responses"> Clique aqui para confirmar sua presença no nosso casamento</a></h3>
...
<!-- FOOTER SECTION -->
<footer>
 <div class="image-divider fixed-height" style="background-image:url(/images/fotos/foto7.jpg);" data-stellar-background-ratio="0.5" >
